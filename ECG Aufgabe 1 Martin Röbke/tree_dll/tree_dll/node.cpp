...
/** Dynamic Link Library C++-File für die Klasse 'node'.
...
DLL_EXPORT int    node::node_id = 0;

// --------FUNKTIONALITÄTEN:---------------

DLL_EXPORT int node::get_node_id()
{
	return node_id;
}

DLL_EXPORT string  node::get_name() const
{
	return name;
}

DLL_EXPORT void  node::set_name(const string& new_name)
{
	name = new_name;
}

DLL_EXPORT unsigned int  node::get_nr_children() const
{
...
*
*/
DLL_EXPORT node*  node::get_child(const unsigned int position) const
{
...
*
*/
DLL_EXPORT void  node::add_child(const node* child)
{
...
*
*/
DLL_EXPORT void  node::print(ostream& str, unsigned int depth, unsigned int intent, const char ws) const
{
...
*
*/
DLL_EXPORT void  node::print_nocycle(ostream& str, unsigned int depth, unordered_set<node*> * p_myset,
...
*
*/
DLL_EXPORT void  node::print_norec(ostream& str, unsigned int intent, const char ws) const
{
...
*
*/
DLL_EXPORT void  node::print_norec_nocycle(std::ostream& str, unsigned int intent, const char ws) const
{
...
* Tiefe >=2 -> nr_childs >= 1.
*/
DLL_EXPORT node*  create_complete_tree(unsigned int nr_child_nodes, unsigned int tree_depth)
{
...
DLL_EXPORT ostream&  operator<<(ostream& str, const node& n)
{
...
*
*/
DLL_EXPORT node::node(const string& in_name)
{
	//ctor
